...
export const mantine_tw_preset: Config = {
  content: [],
  darkMode: ['class', '[data-mantine-color-scheme="dark"]'],
  // corePlugins: { // Preflight is Tailwind CSS's base style reset that applies a layer of default styles to your HTML to promote greater consistency across browsers and a cleaner slate for building your designs.
  //   preflight: false,
  // },
  theme: {
    extend: {
